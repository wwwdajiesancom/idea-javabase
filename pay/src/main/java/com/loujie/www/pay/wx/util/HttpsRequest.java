...
import com.loujie.www.pay.wx.service.base.IWxRequest;
...
public class HttpsRequest implements IWxRequest {
    ...
    public HttpsRequest(WxConfigure wxConfigure) throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException,
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException,
        ...
        if (isSSL) {
            ...
            // HttpsRequest.class.getResourceAsStream("");
